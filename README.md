...
- 영상 생성: `ByteDance/Seedance-1.0-lite` via Together Videos API
...
- 영상은 Together Videos API의 `ByteDance/Seedance-1.0-lite` 모델을 사용합니다.
...
TOGETHER_VIDEO_MODEL=ByteDance/Seedance-1.0-lite
...
- Seedance Lite는 Together API 키와 크레딧이 있어야 호출할 수 있습니다.
